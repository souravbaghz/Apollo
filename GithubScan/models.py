...
class GithubScanTask(models.Model):
    ...
    keyword = models.TextField(db_column="keyword", verbose_name='关键字')
    domain = models.TextField(db_column="domain", verbose_name='域名', null=True, blank=True)
...
class GithubResult(models.Model):
    id = models.AutoField(primary_key=True, db_column="id", verbose_name='序号')
    name = models.CharField(max_length=32, db_column="name", verbose_name='任务名称')
