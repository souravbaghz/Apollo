...
class BruteRegister(models.Model):
    ...
    category_choices = (("1", "WEB暴破"), ("2", "系统暴破"))
    category = models.CharField(max_length=2, choices=category_choices, verbose_name='负载类型')
    file_object = models.FileField(upload_to='BruteScan/ExploitFiles/', null=True, verbose_name="负载上传")
...
class BruteTasks(models.Model):
    ...
    exploit = models.ForeignKey(BruteRegister, verbose_name="暴破负载选择", on_delete=models.CASCADE, default=None)
...
class BruteResult(models.Model):
    id = models.AutoField(primary_key=True, db_column="id", verbose_name='序号')
    ...
    username = models.CharField(max_length=32, db_column="username", verbose_name='账号', default="")
    password = models.CharField(max_length=32, db_column="password", verbose_name='口令', default="")
