...
class AssetList(models.Model):
    ...
    middle_ware = models.CharField(db_column="middle_ware", max_length=50, verbose_name='组件/框架', null=True, blank=True)
...
class AssetTask(models.Model):
    ...
    port_scan_type = models.CharField(max_length=2, choices=port_scan_type_choices, verbose_name='端口自类型')
    timestamp = models.DateField(db_column="timestamp", verbose_name='创建日期')
